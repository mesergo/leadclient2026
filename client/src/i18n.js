...
const DICT = {
  he: {
    ...
    // virtual
    'vir.number': 'מספר וירטואלי', 'vir.target': 'יעד', 'vir.provider': 'ספק IVR', 'vir.premium': 'פרימיום', 'vir.none': 'אין מספרים.', 'vir.leads': 'לידים', 'vir.editChannel': 'לחץ לעריכת הערוץ', 'vir.unassigned': 'ללא שיוך',
    ...
    'usr.suspendedFilter': 'סטטוס', 'usr.activeOnly': 'פעילים', 'usr.suspendedOnly': 'מושעים', 'usr.active': 'פעיל', 'usr.actions': 'פעולות', 'usr.now': 'עכשיו', 'usr.loginAs': 'התחבר כ',
    'imp.bar': 'מחובר כ', 'imp.return': 'חזרה למשתמש הראשי',
    ...
    'ue.title': 'עריכת פרופיל', 'ue.back': 'חזרה', 'ue.save': 'שמירה', 'ue.saved': 'נשמר בהצלחה',
    'ue.tabProfile': 'עריכת פרופיל', 'ue.tabPassword': 'סיסמה', 'ue.tabNotif': 'התראות', 'ue.tabEmail': 'התראות דוא"ל', 'ue.tabSms': 'התראות SMS', 'ue.tabLang': 'שפה', 'ue.tabRestrict': 'הגבלות',
    'ue.username': 'שם משתמש', 'ue.firstName': 'שם פרטי', 'ue.lastName': 'שם משפחה', 'ue.displayName': 'שם להצגה במערכת', 'ue.suspension': 'השעיית משתמש', 'ue.role': 'תפקיד המשתמש',
    'ue.suspNone': 'ללא השעיה', 'ue.suspPermanent': 'השעיה לצמיתות', 'ue.susp1': 'יום אחד', 'ue.susp7': 'שבוע אחד', 'ue.susp14': 'שבועיים', 'ue.susp30': 'חודש אחד', 'ue.susp90': '3 חודשים',
    'ue.newPassword': 'סיסמה חדשה', 'ue.confirmPassword': 'אימות סיסמה', 'ue.pwMismatch': 'הסיסמאות אינן תואמות',
    'ue.weekdays': 'כל ימי החול', 'ue.allDays': 'הכל',
  ...
  en: {
    ...
    'lead.na': 'N/A', 'lead.unknownPhone': 'Unidentified number', 'lead.general': 'General', 'lead.count': 'records', 'lead.export': 'Export', 'lead.status': 'Status', 'lead.tags': 'Tags', 'lead.lastCall': 'Last call', 'ltab.general': 'General info', 'ltab.extra': 'More info', 'ltab.treatment': 'Handling', 'ltab.chat': 'Conversation', 'ltab.assign': 'Assign', 'ltab.reminder': 'Reminder', 'lc.rating': 'Rating', 'lc.addTag': 'Add tag', 'lc.newTag': 'New tag', 'lc.leadInfo': 'Form details', 'lc.tracking': 'Source & tracking', 'lc.source': 'Source', 'lc.ip': 'IP address', 'lc.browser': 'Browser', 'lc.referrer': 'Referrer', 'lc.actionType': 'Action type', 'lc.addTreatment': 'Add entry', 'lc.treatmentEmpty': 'No handling entries', 'lc.msgChannel': 'Channel', 'lc.msgSend': 'Send', 'lc.assignAgent': 'Assign agent', 'lc.assign': 'Assign', 'lc.reminderAt': 'Reminder date', 'lc.addReminder': 'Add reminder', 'lc.noReminders': 'No reminders', 'lc.convert': 'Mark converted', 'act.promised': 'Promised to customer', 'act.offered': 'Offered to customer', 'act.called': 'Called', 'act.meeting': 'Meeting set', 'act.other': 'Other', 'lc.recording': 'Call recording', 'lc.noRecording': 'No recording yet (from IVR)', 'lc.rawDetails': 'Raw details', 'lc.showRaw': 'Show raw details', 'lc.hideRaw': 'Hide', 'lc.autoTag': 'Automatic tag (from call)', 'lc.download': 'Download',
    ...
    'usr.suspendedFilter': 'Status', 'usr.activeOnly': 'Active', 'usr.suspendedOnly': 'Suspended', 'usr.active': 'Active', 'usr.actions': 'Actions', 'usr.now': 'just now', 'usr.loginAs': 'Login as',
    'imp.bar': 'Logged in as', 'imp.return': 'Return to your account',
    'usr.ago.min': '{n} min ago', 'usr.ago.hour': '{n} h ago', 'usr.ago.day': '{n} d ago', 'usr.ago.month': '{n} mo ago', 'usr.ago.year': '{n} y ago',
    'ue.title': 'Edit profile', 'ue.back': 'Back', 'ue.save': 'Save', 'ue.saved': 'Saved successfully',
    'ue.tabProfile': 'Profile', 'ue.tabPassword': 'Password', 'ue.tabNotif': 'Notifications', 'ue.tabEmail': 'Email alerts', 'ue.tabSms': 'SMS alerts', 'ue.tabLang': 'Language', 'ue.tabRestrict': 'Restrictions',
    'ue.username': 'Username', 'ue.firstName': 'First name', 'ue.lastName': 'Last name', 'ue.displayName': 'Display name', 'ue.suspension': 'Suspension', 'ue.role': 'User role',
    'ue.suspNone': 'No suspension', 'ue.suspPermanent': 'Permanent', 'ue.susp1': '1 day', 'ue.susp7': '1 week', 'ue.susp14': '2 weeks', 'ue.susp30': '1 month', 'ue.susp90': '3 months',
    'ue.newPassword': 'New password', 'ue.confirmPassword': 'Confirm password', 'ue.pwMismatch': 'Passwords do not match',
    'ue.weekdays': 'Weekdays (Sun–Fri)', 'ue.allDays': 'All',
