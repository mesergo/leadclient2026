...
const DICT = {
  he: {
    ...
    'dp.allTime': 'כל הזמן', 'dp.today': 'היום', 'dp.yesterday': 'אתמול', 'dp.last2': 'היומיים האחרונים', 'dp.thisWeek': 'השבוע (יום ראשון - היום)', 'dp.last7': '7 הימים האחרונים', 'dp.prevWeek': 'השבוע הקודם', 'dp.last14': '14 הימים האחרונים', 'dp.thisMonth': 'החודש', 'dp.last30': '30 הימים האחרונים', 'dp.prevMonth': 'החודש הקודם',
    ...
    'es.title': 'עריכת ערוץ', 'es.name': 'שם הערוץ', 'es.code': 'קוד ערוץ', 'es.description': 'תיאור הערוץ', 'es.type': 'סוג הערוץ',
    'es.typeWebsite': 'אתר אינטרנט', 'es.typePhone': 'טלפון וירטואלי', 'es.typeWhatsapp': 'וואטסאפ',
    'es.lineType': 'סוג קו', 'es.virtualNumber': 'מספר טלפון וירטואלי', 'es.redirect': 'הפניית טלפון וירטואלי', 'es.siteUrl': 'כתובת אתר אינטרנט ייעודית',
    'es.smsReturn': 'אפשר SMS חוזר ללקוח?', 'es.smsFrom': 'מספר טלפון למשלוח SMS', 'es.smsText': 'תוכן ההודעה היוצאת',
    'es.smsCharCount': 'מספר התווים בהודעה', 'es.smsMsgCount': 'מספר ההודעות', 'es.smsCost': 'אני מאשר כי אני מודע לכך שאפשרות זו עולה 0.2₪ עבור הודעת SMS',
    ...
    'es.addTitle': 'הוספת ערוץ', 'es.addSave': 'הוספת ערוץ', 'es.numberNone': 'ללא', 'es.selectPlan': 'בחר מסלול', 'es.nameRequired': 'שם ערוץ נדרש', 'es.search': 'חיפוש...',
    'es.afterHours': 'לאחר שעות הפתיחה', 'es.afterNone': 'ללא', 'es.afterPhone': 'הפניה למספר טלפון אחר', 'es.afterAudio': 'השמעת קובץ שמע',
  ...
  en: {
    ...
    'dp.allTime': 'All time', 'dp.today': 'Today', 'dp.yesterday': 'Yesterday', 'dp.last2': 'Last 2 days', 'dp.thisWeek': 'This week (Sun-today)', 'dp.last7': 'Last 7 days', 'dp.prevWeek': 'Previous week', 'dp.last14': 'Last 14 days', 'dp.thisMonth': 'This month', 'dp.last30': 'Last 30 days', 'dp.prevMonth': 'Previous month',
    ...
    'es.title': 'Edit channel', 'es.name': 'Channel name', 'es.code': 'Channel code', 'es.description': 'Channel description', 'es.type': 'Channel type',
    'es.typeWebsite': 'Website', 'es.typePhone': 'Virtual phone', 'es.typeWhatsapp': 'WhatsApp',
    'es.lineType': 'Line type', 'es.virtualNumber': 'Virtual phone number', 'es.redirect': 'Call redirect', 'es.siteUrl': 'Dedicated website URL',
    'es.smsReturn': 'Enable return SMS to customer?', 'es.smsFrom': 'SMS sender number', 'es.smsText': 'Outgoing message text',
    'es.smsCharCount': 'Characters', 'es.smsMsgCount': 'Messages', 'es.smsCost': 'I confirm I am aware this costs 0.2₪ per SMS message',
    ...
    'es.addTitle': 'Add channel', 'es.addSave': 'Add channel', 'es.numberNone': 'None', 'es.selectPlan': 'Choose plan', 'es.nameRequired': 'Channel name is required', 'es.search': 'Search...',
    'es.afterHours': 'After opening hours', 'es.afterNone': 'None', 'es.afterPhone': 'Redirect to another phone number', 'es.afterAudio': 'Play an audio file',
